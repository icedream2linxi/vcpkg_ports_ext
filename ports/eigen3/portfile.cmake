...
file(GLOB INC_FILES ${CURRENT_PACKAGES_DIR}/include/eigen3/*)
foreach(INC_FILE ${INC_FILES})
    get_filename_component(FILE_NAME ${INC_FILE} NAME)
    file(RENAME ${INC_FILE} ${CURRENT_PACKAGES_DIR}/include/${FILE_NAME})
endforeach()
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/include/eigen3)
